...
const PLANS = [
    {
        ...
        price: "¥0",
        period: "ずっと無料",
        features: ["LINEグループ 1件", "月30回 AI応答", "ナレッジ 1件登録"],
    },
    {
        id: "starter",
        name: "Starter",
        price: "¥4,980",
        period: "/ 月",
        features: ["LINEグループ 1件", "月300回 AI応答", "ナレッジ 5件登録", "メールサポート"],
    },
    {
        id: "standard",
        name: "Standard",
        price: "¥9,800",
        period: "/ 月",
        features: ["LINEグループ 3件", "月1,000回 AI応答", "ナレッジ 20件登録", "Web検索AI（RAG）", "エスカレーション通知", "優先サポート"],
        popular: true,
    },
    {
        id: "pro",
        ...
        price: "¥29,800",
        period: "/ 月",
        features: ["LINEグループ 10件", "月5,000回 AI応答", "ナレッジ 100件登録", "Web検索AI（RAG）", "外部ツール連携", "エスカレーション通知", "AI人格カスタマイズ", "専任サポート"],
    },
];
