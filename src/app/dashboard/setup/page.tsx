...
export default function SetupPage() {
    ...
    return (
        <div className="min-h-screen bg-[#FFFFFF] flex flex-col items-center justify-center px-4 py-12">
            <div className="w-full max-w-[560px]">
                ...
                <AnimatePresence mode="wait">
                    ...
                    {step === 1 && (
                        ...
                        >
                            <h2 className="text-[18px] font-semibold text-[#1A1A1A] mb-1">STEP 1: ナレッジ登録</h2>
                            <p className="text-[13px] text-[#999999] mb-6">
                            ...
                            <div
                                ...
                                className={`mb-4 border-2 border-dashed rounded-xl p-6 text-center cursor-pointer transition-all ${dragOver ? "border-[#06C755] bg-[#06C755]/5" : "border-[#E8E8E8] hover:border-[#D0D0D0]"}`}
                            >
                                <label className="cursor-pointer block">
                                    ...
                                    />
                                    <Upload size={24} className="text-[#AAAAAA] mx-auto mb-2" />
                                    <p className="text-[13px] text-[#999999]">PDFをドロップ または クリックして選択</p>
                                </label>
                            </div>
                            ...
                            <div className="relative mb-4">
                                ...
                                <div className="relative flex justify-center text-[11px] text-[#AAAAAA] bg-white px-2">または テキストで入力</div>
                            </div>
                            ...
                            <input
                                ...
                                className="w-full mb-3 bg-[#F9FAFB] border border-[#E8E8E8] rounded-lg px-3 py-2.5 text-[13px] text-[#1A1A1A] placeholder:text-[#CCCCCC] focus:border-[#06C755] focus:outline-none"
                            />
                            <textarea
                                value={knowledgeText}
                                ...
                                rows={5}
                                className="w-full bg-[#F9FAFB] border border-[#E8E8E8] rounded-lg px-3 py-2.5 text-[13px] text-[#1A1A1A] placeholder:text-[#CCCCCC] focus:border-[#06C755] focus:outline-none resize-none"
                            />
                            ...
                            <div className="flex gap-3 mt-6">
                                ...
                                <button
                                    ...
                                    disabled={loading}
                                    className="flex-1 flex items-center justify-center gap-2 bg-[#06C755] hover:bg-[#08E065] disabled:opacity-50 text-[#1A1A1A] font-medium py-2.5 rounded-xl text-[14px] transition-all active:scale-95"
                                >
                                    {loading ? "保存中..." : "次へ"}
                    ...
                    {step === 2 && (
                        <motion.div
                            ...
                            className="bg-white border border-[#E8E8E8] rounded-2xl p-6"
                        >
                            <h2 className="text-[18px] font-semibold text-[#1A1A1A] mb-1">STEP 2: LINE公式アカウント連携</h2>
                            ...
                            {/* Guide */}
                            <div className="bg-[#06C755]/5 border border-[#06C755]/20 rounded-xl p-4 mb-5 text-[12px] text-[#666666] leading-relaxed">
                    ...
                    {step === 3 && (
                        <motion.div
                            ...
                            className="bg-white border border-[#06C755]/30 rounded-2xl p-6 text-center"
                        >
                            ...
                            <h2 className="text-[22px] font-bold text-[#1A1A1A] mb-2">接続成功 🎉</h2>
                            ...
                            <button
                                ...
                                className="w-full bg-[#06C755] hover:bg-[#08E065] text-[#1A1A1A] font-medium py-3 rounded-xl text-[15px] transition-all active:scale-95"
                            >
                                ダッシュボードへ
                            </button>
                        </motion.div>
