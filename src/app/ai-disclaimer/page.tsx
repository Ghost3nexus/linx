  ...
  return (
    <main className="min-h-screen bg-white text-[#1A1A1A]">
      <div className="max-w-[720px] mx-auto px-6 py-20">
        ...
        <p className="text-[13px] text-[#999999] mb-10">制定日: 2026年3月6日</p>
        ...
        <div className="space-y-8 text-[15px] leading-relaxed text-[#333333]">
          <section>
            ...
            <p className="mb-3">本免責事項は、株式会社TomorrowProofが提供する以下のサービスにおけるAI生成物（テキスト、画像、コード、分析結果等）に適用されます。</p>
          ...
          <section>
            <h2 className="text-[18px] font-semibold text-[#1A1A1A] mb-3">第2条（AI生成物の性質）</h2>
          ...
          <section>
            <h2 className="text-[18px] font-semibold text-[#1A1A1A] mb-3">第3条（品質保証の範囲と限界）</h2>
            <p>当社はAI生成物の正確性、完全性、最新性、特定目的への適合性を保証しません。品質は利用者の入力情報に依存し、出力の再現性も保証しません。</p>
          </section>

          <section>
            <h2 className="text-[18px] font-semibold text-[#1A1A1A] mb-3">第4条（著作権・知的財産権）</h2>
          ...
          <section>
            <h2 className="text-[18px] font-semibold text-[#1A1A1A] mb-3">第5条（第三者の権利侵害）</h2>
            <p>AI生成物が既存の著作物等と類似する可能性があります。商業利用の際は第三者の権利を侵害していないか確認してください。AI生成物の使用に起因する紛争は、利用者の責任において解決するものとします。</p>
          </section>

          <section>
            <h2 className="text-[18px] font-semibold text-[#1A1A1A] mb-3">第6条（禁止事項）</h2>
            <ul className="list-disc list-inside space-y-1">
          ...
          <section>
            <h2 className="text-[18px] font-semibold text-[#1A1A1A] mb-3">第7条（損害賠償の制限）</h2>
          ...
          <section>
            <h2 className="text-[18px] font-semibold text-[#1A1A1A] mb-3">第8条（データの取り扱い）</h2>
            <p>
          ...
          <section>
            <h2 className="text-[18px] font-semibold text-[#1A1A1A] mb-3">第9条（サービスの変更・中断）</h2>
            <p>AIモデルのアップデートや保守により、事前通知なくサービスを変更・中断する場合があります。これに起因する損害について、当社の故意・重過失を除き責任を負いません。</p>
          </section>

          <section>
            <h2 className="text-[18px] font-semibold text-[#1A1A1A] mb-3">第10条（準拠法・管轄裁判所）</h2>
            <p>準拠法は日本法。東京地方裁判所を第一審の専属的合意管轄裁判所とします。</p>
          </section>

          <p className="text-[13px] text-[#999999] pt-6 border-t border-[#E8E8E8]">
            2026年3月6日 施行 — 株式会社TomorrowProof 代表取締役 KOZUKI TAKAHIRO
          </p>
        </div>
      </div>
    </main>
