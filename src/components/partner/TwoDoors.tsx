...
const doors = [
  {
    ...
    tag: "販売代理店の方へ",
    title: "売る商材が、ひとつ増えます。",
    body: "すでに店舗のお客様を抱えている会社に向いています。LINE構築、広告運用、業種特化のコンサルティング。既存の取引先にそのまま案内でき、開発も在庫も要りません。",
    points: [
      "仕入れは卸値のみ。初期費用も最低販売数もなし",
      "販売価格・契約期間は御社が決める",
      "AI応答は実費で仕入れ、上乗せ幅も御社が決める",
    ],
    href: "#simulator",
    cta: "取り分を試算する",
  },
  {
    ...
    body: "複数店舗を運営する企業、FC本部、チェーン本部、業界団体に向いています。加盟店に配る運営基盤を、自社の名前で持てます。開発期間も開発チームも不要です。",
    points: [
      "エンドユーザーの画面にLINXの名前は出ない",
      "店舗数無制限の固定枠プランを用意",
      "既存の予約システムを残したまま追加できる",
    ],
    href: "#simulator",
    cta: "固定枠で試算する",
  },
