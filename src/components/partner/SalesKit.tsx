...
const kit = [
  {
    icon: FileText,
    title: "業種別の提案ページ 8本",
    body: "ジム予約管理、美容室の予約・顧客管理、ヨガ、ピラティス、クリニック、サウナ、スタジオ、ピックルボール。業種ごとに課題と機能を書き分けてあります。商談でそのまま開けます。",
  },
  {
    icon: MonitorPlay,
    title: "紹介動画",
    body: "深夜の問い合わせにAIが応対し、そのまま予約を自動確定するまでを60秒で見せる動画です。現状は当社名義のため、御社名義版はご契約時に個別でご用意します。",
  },
  {
    icon: MessageCircle,
    title: "デモ環境（2面）",
    body: "お客様が触る公式LINEと、店舗が使う管理画面の両方。管理画面はログイン不要のURLをお渡しするので、商談の場でそのまま開けます。",
  },
];
    ...
    <section className="py-[60px] sm:py-[95px] px-6 bg-white">
      <div className="max-w-[1100px] mx-auto">
        ...
        <p className="mt-5 text-center text-[#666666] text-[15px] sm:text-[16px] leading-[1.85] max-w-[620px] mx-auto">
          ホワイトラベルは開発の負担を消しますが、売る仕事までは消しません。
          <br className="hidden sm:block" />
          そこで要るものを、最初から揃えてあります。
        </p>
